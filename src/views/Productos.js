      ...
      {tipo == "videogames" &&
        ...
        {productos.map((producto) => (
          <div key={producto.id} className={"producto"}>
           ...
           <input placeholder="cantidad.." min="1" onChange={cant => this.cambiarCantidad(cant.target.value,producto.id)} type="number" className="form-control cantidades-productos"/>
