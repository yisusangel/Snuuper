      ...
      <div>
        ...
        {cart.map((prod) => (
          <tr key={prod.producto.id}>
             ...
             <td><input placeholder="cantidad.." min="1" defaultValue={prod.cantidad} onChange={cant => this.cambiarCantidad(cant.target.value,prod.id)} type="number" className="form-control"/></td>
